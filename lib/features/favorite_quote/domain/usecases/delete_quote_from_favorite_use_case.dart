...
class DeleteQuoteFromFavoriteUseCase extends UseCase<void, Quote> {
  final FavoriteQuoteRepository favoriteQuoteRepository;

  DeleteQuoteFromFavoriteUseCase({required this.favoriteQuoteRepository});

  @override
  Future<Either<Failure, void>> call(Quote quote) async {
    try {
      await favoriteQuoteRepository.removeQuoteFromFavorites(quote);
